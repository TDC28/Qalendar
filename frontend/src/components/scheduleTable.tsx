...
import { Table, TableHeader, TableColumn, TableBody, TableRow, TableCell, Progress, spacer, Spacer } from "@nextui-org/react";
...
//   }, []);
  ...
  return (
    <>
      <div style={{ marginBottom: '5px' }}> {/* Spacing between Button and Table */}
